    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="inline-flex flex-col xs:flex-row items-center gap-2 xs:gap-4 px-6 xs:px-8 py-3 sm:py-4 bg-white/15 backdrop-blur-lg rounded-full border border-white/30 mb-6 sm:mb-10 animate-fade-in shadow-2xl hover:bg-white/20 transition-all duration-500">
              ...
              <span className="text-base font-semibold tracking-wide">Trusted by 500+ Happy Clients in Visakhapatnam</span>
            ...
            <p className="text-base xs:text-lg md:text-2xl lg:text-3xl text-gray-100 mb-10 sm:mb-16 font-light max-w-2xl sm:max-w-6xl mx-auto leading-relaxed animate-fade-in drop-shadow-lg" style={{ animationDelay: '0.2s' }}>
              Experience complete interior transformation in Visakhapatnam with our end-to-end design and build services for homes, offices, and commercial spaces. 
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-20">
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              From concept to completion, we deliver complete interior design solutions for homes, apartments, and commercial spaces across Visakhapatnam. Our team travels to your location with transparent pricing and premium materials.
            </p>
          </div>
            ...
            <div className="group relative overflow-hidden rounded-3xl bg-white shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-3">
              ...
              <div className="p-8">
                <p className="text-gray-600 mb-6 text-lg leading-relaxed">
                  Transform your Visakhapatnam home with our proven interior design process. From 3D visualization to final installation, we ensure every detail meets your vision with our transparent workflow and quality guarantee.
                </p>
            ...
            {[
              {
                ...
                description: "We visit your space in Visakhapatnam, understand your needs, and provide honest advice with transparent pricing.",
                icon: Phone
              },
              {
                step: "02", 
      ...
      <section className="py-24 px-4 bg-white">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-6xl font-bold mb-8 bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">
              Why Choose Us for Your Visakhapatnam Interior Project?
            </h2>
          </div>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-3xl p-8 lg:p-12">
                ...
                <p className="text-gray-600 mb-8 text-lg leading-relaxed">
                  Join hundreds of satisfied customers in Visakhapatnam who have transformed their spaces with our transparent process and quality guarantee.
                </p>
